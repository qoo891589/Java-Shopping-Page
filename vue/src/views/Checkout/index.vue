...
<template>
    ...
    <div class="container">
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            <div class="text">
              <div class="none" v-if="!curAddress">您需要先添加收貨位址才可提交訂單。</div>
              <ul v-else>
            ...
            <div class="action">
              <el-button size="large" @click="showDialog = true">切換位址</el-button>
        ...
        <div class="box-body">
          <a class="my-btn active" href="javascript:;">不限送貨時間：週一至周日</a>
          <a class="my-btn" href="javascript:;">工作日送貨：週一至週五</a>
          <a class="my-btn" href="javascript:;">雙休日、假日送貨：週六至周日</a>
        </div>
        <!-- 支付方式 -->
  ...
  <!-- 切換位址 -->
  <el-dialog v-model="showDialog" title="切換收貨位址" width="30%" center>
